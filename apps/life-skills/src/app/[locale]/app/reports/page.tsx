...
export default async function Page({ params, searchParams }: { params: Promise<{ locale: string }>; searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <ReportsPage locale={locale} role="practitioner" caseId={typeof query.caseId === "string" ? query.caseId : undefined} audienceId={typeof query.audienceId === "string" ? query.audienceId : undefined} />;
}
