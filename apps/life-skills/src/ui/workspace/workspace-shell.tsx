...
import { activeItem, breadcrumbItems, navigationGroups, primaryNavigation, workspaceHref, type NavItem, type WorkspaceRole } from "./navigation-model.ts";
...
export function WorkspaceShell({ locale, role, pathname, caseId, section, languageHref, children, toHref, notice }: WorkspaceShellProps) {
  ...
  return <div className={`lsw lsu lsu--${role}`} lang={locale} dir={locale === "he" ? "rtl" : "ltr"}>
    ...
    <div className="lsu-mobile-tabs">{topTabs}</div>
